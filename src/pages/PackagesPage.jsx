            ...
            <div className="col-span-1 space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                ...
                <button
                  ...
                  disabled={generating}
                  className="w-full bg-primary-orange hover:bg-hover-orange text-white py-2 rounded font-medium transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                >
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <button
                      ...
                      disabled={deploying}
                      className="bg-primary-orange hover:bg-hover-orange text-white px-6 py-2 rounded font-medium transition-colors shadow flex items-center gap-2 disabled:opacity-50"
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                ...
                <button className="w-full bg-primary-orange hover:bg-hover-orange text-white py-2 rounded-lg font-medium shadow-sm transition-all flex items-center justify-center gap-2">
